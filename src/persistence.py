"""JSON-backed user profile storage for engagement data."""
...
def save_user_session(
    ...
    try:
        fd, tmp_path = tempfile.mkstemp(dir=settings.root_dir, suffix=".tmp")
